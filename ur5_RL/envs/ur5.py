...
class ur5:
    ...
    def action(self, motorCommands):
        ...
        if self.three_D:
            self._p.setJointMotorControlArray(self.uid, indexes, self._p.POSITION_CONTROL, targetPositions=poses, targetVelocities =[0]*l, positionGains = [0.03]*l, forces = forces)
